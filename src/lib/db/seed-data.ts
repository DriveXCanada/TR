...
export const ROSTER: readonly SeedVolunteer[] = [
  ...
  { first: 'Silas', last: 'Grimsdottir', role: 'Core Ops', phoneTail: '24', arriveDate: '2026-03-02', arriveMeal: 'breakfast', departDate: '2026-03-08', departMeal: 'supper' },
  { first: 'Magdalena', last: 'Ossowski', role: 'Core Ops', phoneTail: '25', arriveDate: '2026-03-02', arriveMeal: 'breakfast', departDate: '2026-03-08', departMeal: 'supper',
    restrictions: [{ key: 'vegan', severity: 'preference' }] },
  { first: 'Ignatius', last: 'Fairweather', role: 'Core Ops', phoneTail: '26', arriveDate: '2026-03-04', arriveMeal: 'lunch', departDate: '2026-03-08', departMeal: 'supper' },
  { first: 'Rosalind', last: 'Ekwueme', role: 'Core Ops', phoneTail: '27', arriveDate: '2026-03-02', arriveMeal: 'breakfast', departDate: '2026-03-07', departMeal: 'supper' },
  { first: 'Barnaby', last: 'Threlfall', role: 'Site Survey', phoneTail: '28', arriveDate: '2026-03-05', arriveMeal: 'breakfast', departDate: '2026-03-08', departMeal: 'supper' },
  { first: 'Clementine', last: 'Abernathy-Rao', role: 'Site Survey', phoneTail: '29', arriveDate: '2026-03-05', arriveMeal: 'breakfast', departDate: '2026-03-08', departMeal: 'supper',
    restrictions: [{ key: 'gluten', severity: 'intolerance' }] },
  { first: 'Horatio', last: 'Nwachukwu', role: 'Site Survey', phoneTail: '30', arriveDate: '2026-03-05', arriveMeal: 'breakfast', departDate: '2026-03-08', departMeal: 'supper' },
  { first: 'Wilhelmina', last: 'Bergström-Cruz', role: 'Site Survey', phoneTail: '31', arriveDate: '2026-03-05', arriveMeal: 'lunch', departDate: null, departMeal: null },
