...
export const KIT_TEMPLATES: readonly KitTemplate[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Chainsaw', category: 'equipment', issuePolicy: 'per_deployment', qtyPerPerson: 0.35, unit: 'each', notes: 'Roughly one saw per three-person team.' },
      ...
      { name: 'Spare chain', category: 'consumable', issuePolicy: 'periodic', intervalDays: 2, qtyPerPerson: 0.35, unit: 'each' },
      { name: 'Felling wedges', category: 'tool', issuePolicy: 'per_deployment', qtyPerPerson: 0.35, unit: 'set' },
